...
export class LeafletMap {
    ...
    terrainLayerControl() {
        this.control = L.control.layers(this.baseLayers.Terrain, this.overlays).addTo(this.imap);
    }

    satelliteLayerControl() {
        this.control = L.control.layers(this.baseLayers.Satellite, this.overlays).addTo(this.imap);
    }
